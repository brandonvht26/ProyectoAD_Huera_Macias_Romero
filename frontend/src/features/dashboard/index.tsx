          ...
          <TabsContent value='overview' className='space-y-4'>
            <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
              <Card>
                ...
                <CardContent>
                  ...
                  <p className='text-xs text-muted-foreground'>
                    +0.3 puntos desde el semestre anterior
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <div className='text-2xl font-bold'>124 / 160</div>
                  <p className='text-xs text-muted-foreground'>
                    77% del avance de carrera
                  </p>
                </CardContent>
              </Card>
              <Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className='text-2xl font-bold'>140 hrs</div>
                  <p className='text-xs text-muted-foreground'>
                    Prácticas pre-profesionales completadas
                  </p>
                </CardContent>
              </Card>
            </div>
            <div className='grid grid-cols-1 gap-4 lg:grid-cols-7'>
              ...
              <Card className='col-span-1 lg:col-span-3'>
                <CardHeader>
                  ...
                  <CardDescription>
                    Se registraron 5 notas nuevas este bimestre.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <RecentSales />
